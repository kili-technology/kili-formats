...
latest_label_annotations_rectangle = {
        ...
        {'__typename': 'VideoObjectDetectionAnnotation',
         ...
         'keyAnnotations': [
             {'frame': 0,
              ...
              'annotationValue': {
                  'vertices': [[[{'x': 0.37250948766603414, 'y': 0.7419354838709677},
    ...
    'jsonResponse': {'0': {'ANNOTATION_JOB_COUNTER': {'JOB_0': {'OBJECT_B': 1}},
                           'ANNOTATION_NAMES_JOB': {'20250602131121389-7': 'Car 1'}}}, 'labelType': 'DEFAULT',
    'modelName': None}
...
latest_label_annotations_polygon = {
        ...
        {'__typename': 'VideoObjectDetectionAnnotation',
         ...
         'keyAnnotations': [
             {'frame': 0,
              ...
              'annotationValue': {
                  'vertices': [[[{'x': 0.36717267552182165, 'y': 0.5957106226563309},
    ...
    'isLatestLabelForUser': True,
    'isSentBackToQueue': False,
    'jsonResponse': {'0': {'ANNOTATION_JOB_COUNTER': {'OBJECT_DETECTION_JOB': {'TEST': 1}},
                           'ANNOTATION_NAMES_JOB': {'20250602134206930-10': 'Test 1'}}}, 'labelType': 'REVIEW',
    'modelName': None}
        ...
        {'__typename': 'VideoObjectDetectionAnnotation',
         ...
         'keyAnnotations': [
             {'frame': 0,
              ...
              'annotationValue': {
                  'vertices': [[[{'x': 0.38416210624999997, 'y': 0.5150611305555556},
        ...
        {'__typename': 'VideoObjectDetectionAnnotation',
         ...
         'keyAnnotations': [
             {'frame': 0,
              'id': '20250602144338196-2-0',
              'annotationValue': {
                  'vertices': [[[{'x': 0.3841253416666667, 'y': 0.5151101416666666},
                                 {'x': 0.38413453281250004, 'y': 0.5151101416666666},
                                 {'x': 0.38413453281250004, 'y': 0.5151183101851852},
                                 {'x': 0.384139128125, 'y': 0.5151183101851852},
                                 {'x': 0.38414372395833335, 'y': 0.5151264787037038},
                ...
                'annotations': [
                    {
                        ...
                        'type': 'rectangle',
                        'boundingPoly': [
                            {'normalizedVertices': [{'x': 0.37250948766603414, 'y': 0.7419354838709677},
                                                    {'x': 0.37250948766603414, 'y': 0.5711574952561669},
                                                    {'x': 0.5005929791271347, 'y': 0.5711574952561669},
                                                    {'x': 0.5005929791271347, 'y': 0.7419354838709677}]
                             }
...
test_cases = [
    (json_interface_rectangle, latest_label_annotations_rectangle, expected_latest_label_result_rectangle),
    (json_interface_polygon, latest_label_annotations_polygon, expected_latest_label_result_polygon),
    (json_interface_semantic, latest_label_annotations_semantic, expected_latest_label_result_semantic),
    (json_interface_semantic, latest_label_annotations_semantic_with_hole, expected_latest_label_result_with_hole),
    (json_interface_semantic, latest_label_annotations_semantic_multipart,
     expected_latest_label_result_semantic_multipart)
]
